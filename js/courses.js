 ...
 */
export function generateActivities(course, preferences) {
  const activities = [];
  ...
  for (let i = 0; i < objectives.length; i++) {
    ...
    activities.push({
      ...
      objectiveIndex: i,
      type: 'explore',
      instruction: exploreInstruction(obj, level),
    ...
    activities.push({
      ...
      objectiveIndex: i,
      type: 'apply',
      instruction: applyInstruction(obj, level),
      criteria: [
    ...
    if (isLast) {
      activities.push({
        ...
        objectiveIndex: i,
        type: 'final',
        instruction: finalInstruction(obj, course),
      ...
      activities.push({
        ...
        objectiveIndex: i,
        type: 'create',
        instruction: createInstruction(obj, level),
